...
.. code-block:: bash
   ...
   tenant_add name=job_step_task_tenant metrics=job_id,step_id,task_id

   # Define a tenant by job only
   tenant_add name=job_tenant metrics=job_id

   # Define a tenant by job and user
   tenant_add name=job_user_tenant metrics=job_id,user_id
...
.. code-block:: bash
   ...
   tenant_add name=job_tenant metrics=job_id
   tenant_add name=job_step_tenant metrics=job_id,step_id
